...
power range is: -9223372036854775808 through 9223372036854775807. Because of
how the current proposer selection algorithm works, we do not recommend having
voting powers greater than 1000000000000 (see `Proposals section of Byzantine
Consensus Algorithm
